...
public class ScanGalleryActivity extends AppCompatActivity {
    ...
    private boolean checkStoragePermission() {
        ...
        boolean result = ContextCompat.checkSelfPermission(ScanGalleryActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED;
    ...
    private boolean checkCameraPermission() {
        ...
        boolean cameraResult = ContextCompat.checkSelfPermission(ScanGalleryActivity.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED;
